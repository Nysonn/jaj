    ...
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="relative z-10 min-h-screen flex flex-col items-center justify-center px-4">
        <div className={`max-w-md w-full text-center transition-all duration-1000 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          ...
          <div className="backdrop-blur-xl bg-white/70 border border-white/30 rounded-3xl p-8 shadow-2xl shadow-orange-500/10 hover:shadow-orange-500/20 transition-all duration-500 hover:scale-105">
            ...
            <h1 className="text-4xl font-bold bg-gradient-to-r from-[#FA5D0F] via-orange-600 to-pink-600 bg-clip-text text-transparent mb-6 hover:scale-105 transition-transform duration-300">
              Welcome to JAJ
            </h1>
            
            {/* Subtitle with enhanced styling */}
            <p className="text-gray-700/80 mb-10 text-lg leading-relaxed font-medium">
              Campus Life, <span className="text-orange-600 font-semibold">Simplified</span>. Order groceries and daily necessities right from your hostel.
            </p>
        ...
        <div className={`mt-12 transition-all duration-1500 delay-500 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
          <div className="flex items-center space-x-2 text-gray-500/60 text-sm">
            ...
            <span className="font-medium">Your campus companion</span>
